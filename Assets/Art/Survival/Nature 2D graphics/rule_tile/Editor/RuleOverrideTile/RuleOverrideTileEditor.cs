...
{
    [CustomEditor(typeof(UnityEngine.Tilemaps.RuleOverrideTile))]
    public class RuleOverrideTileEditor : Editor
    {

        public UnityEngine.Tilemaps.RuleOverrideTile overrideTile => target as UnityEngine.Tilemaps.RuleOverrideTile;
